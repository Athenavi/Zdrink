...
export default function WeixinCallbackPage() {
        ...
        <div
            ...
            <div className="bg-white rounded-lg shadow-xl p-8 max-w-md w-full text-center">
                {error ? (
                    ...
                    <>
                        <div
                            className="animate-spin rounded-full h-16 w-16 border-b-2 border-green-500 mx-auto mb-4"></div>
                        <h2 className="text-2xl font-semibold text-gray-800 mb-4">正在登录...</h2>
                        <p className="text-gray-600">请稍候，正在完成微信登录</p>
                    </>
                )}
            </div>
        </div>
