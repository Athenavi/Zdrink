    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "apply_to_ids",
                    models.JSONField(
                        blank=True, default=list, verbose_name="适用范围ID列表"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "condition_quantity",
                    models.IntegerField(blank=True, null=True, verbose_name="条件数量"),
                ),
                (
                    "discount_rate",
                    models.DecimalField(
                ...
                (
                    "gift_quantity",
                    models.IntegerField(default=1, verbose_name="赠品数量"),
                ),
                ("valid_from", models.DateTimeField(verbose_name="生效时间")),
                ("valid_until", models.DateTimeField(verbose_name="过期时间")),
                (
